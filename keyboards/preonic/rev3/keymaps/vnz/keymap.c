 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Hyper |Space |Lower |Raise |Space | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_BASE] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, KC_HYPR, KC_SPC,  TL_LOWR, TL_UPPR, KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, FR_AA2,  FR_EA3,  FR_EA1,  _______, _______, _______, FR_UA2,  FR_IA1,  FR_OA1,  FR_OA2,  KC_DEL,
  _______, FR_AA1,  FR_EA4,  FR_EA2,  _______, _______, _______, _______, FR_IA2,  FR_UA1,  FR_UA3,  EURO,
 ...
 * | Boot |   A  |   E  |   E  |   (  |   [  |   ]  |   )  |   I  |   U  |   U  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |   C  |UC_MAC|UC_WIN| NKRO |UC_LNX|      |      |   \  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_preonic_grid(
  _______, KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_EQL,
