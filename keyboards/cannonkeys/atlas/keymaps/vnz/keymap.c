...
[_RAISE] = LAYOUT_ortho_5x12(
  ...
  _______, FR_AA2,  FR_EA3,  FR_EA1,  _______, _______, _______, FR_UA1,  FR_IA1,  FR_OA1,  FR_OA2,  _______,
  _______, FR_AA1,  FR_UA2,  FR_EA2,  _______, _______, _______, _______, FR_IA2,  FR_UA3,  _______, EURO,
  _______, _______, _______, FR_CA1,  _______, _______, _______, _______, FR_EA4,  _______, _______, _______,
...
[_ADJUST] = LAYOUT_ortho_5x12(
  ...
  _______, FR_AM2,  FR_EM3,  FR_EM1,  KC_PIPE, KC_LCBR, KC_RCBR, FR_UM1,  FR_IM1,  FR_OM1,  FR_OM2,  _______,
  QK_BOOT, FR_AM1,  FR_UM2,  FR_EM2,  KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, FR_IM2,  FR_UM3,  _______, _______,
  _______, _______, _______, FR_CM1,  _______, _______, _______, _______, FR_EM4,  _______, KC_BSLS, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
)
};
